...
CORPUS: list[Evidence] = [
    ...
    # ── 🧾 세무(Cora) 코퍼스 [T#] — 법령·국세청 근거(2026-07 웹 교차검증). 세법은 매년 개정: 기준연도 병기 ──
    Evidence("T1", "cora", "부가세 확정신고: 일반과세자 연 2회(1기 7/25·2기 익년 1/25), 간이과세자 연 1회(익년 1/25)", "부가가치세법 §48·§49, 국세청"),
    Evidence("T2", "cora", "간이과세 기준: 직전 연도 공급대가 1억 400만원 미만(2024.7.~) — 4,800만원 미만은 납부의무 면제", "부가가치세법 시행령 §109, 국세청(2026 확인)"),
    Evidence("T3", "cora", "종합소득세 신고: 다음해 5/1~5/31 (성실신고확인 대상자는 6/30)", "소득세법 §70·§70의2"),
    Evidence("T4", "cora", "적격증빙(세금계산서·현금영수증·카드) 수취가 매입세액공제·필요경비 인정의 전제", "부가가치세법 §38, 소득세법 §160의2"),
    Evidence("T5", "cora", "간편장부대상자가 복식부기 기장 시 기장세액공제 20%(한도 100만원) — 무기장 시 가산세 20%", "소득세법 §56의2·§81의5"),
    Evidence("T6", "cora", "노란우산공제 납입액 소득공제 — 사업소득 4천만원 이하 연 최대 600만원(2025년 납입분부터, 소득구간별 차등)", "조세특례제한법 §86의3, 중기중앙회(2026 확인)"),
    Evidence("T7", "cora", "신용카드·현금영수증 발행세액공제 1.3%, 연 1,000만원 한도(2026.12.31.까지 — 이후 1%·500만원 축소 예정)", "부가가치세법 §46(2026 확인)"),
    Evidence("T8", "cora", "중소기업 특별세액감면 — 업종·규모·지역별 감면(일몰·요건 매년 변동, 적용 전 당해연도 확인 필수)", "조세특례제한법 §7"),
    Evidence("T9", "cora", "복식부기의무자는 사업용 계좌 신고·사용 의무 — 미이행 시 가산세", "소득세법 §160의5"),
]
